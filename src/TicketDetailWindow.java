...
public class TicketDetailWindow extends JFrame {
    ...
    public TicketDetailWindow(String name, String departureFrom, String departureTo, String seat, int totalCost, Date departureDate) {
        ...
        nameLabel.setForeground(Color.DARK_GRAY); // Dark gray text
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        printButton.setBackground(Color.GREEN); // Green background
        printButton.setForeground(Color.WHITE); // White text
        gbc.gridx = 0;
        gbc.gridy = 6;
        panel.add(printButton, gbc);

        printButton.addActionListener(e -> {
            // Simulate printing the ticket
...
//            PdfWriter.getInstance(document, new FileOutputStream(filePath));
         ...
         // Add a title with a custom font
            ...
            // Add ticket details in a table for better layout
            PdfPTable table = new PdfPTable(2); // 2 columns.
            table.setWidthPercentage(100); // Full width.
            table.setWidths(new int[]{1, 3}); // Column widths.
            ...
            // Add a footer with a custom font
